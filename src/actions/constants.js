...
export const SHR_COUNTS_FAILED = 'SHR_COUNTS_FAILED'
export const SHR_COUNTS_FETCHING = 'SHR_COUNTS_FETCHING'
export const SHR_COUNTS_RECEIVED = 'SHR_COUNTS_RECEIVED'
