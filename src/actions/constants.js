...
export const FOOTNOTE_FAILED = 'FOOTNOTE_FAILED'
export const FOOTNOTE_FETCHING = 'FOOTNOTE_FETCHING'
export const FOOTNOTE_RECEIVED = 'FOOTNOTE_RECEIVED'

export const COUNTY_DATA_FAILED = 'COUNTY_DATA_FAILED'
export const COUNTY_DATA_FETCHING = 'COUNTY_DATA_FETCHING'
export const COUNTY_DATA_RECEIVED = 'COUNTY_DATA_RECEIVED'
